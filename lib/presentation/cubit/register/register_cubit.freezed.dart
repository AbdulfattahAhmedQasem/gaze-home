...
class _$RegisterStateImpl implements _RegisterState {
  ...
  @override
  String toString() {
    return 'RegisterState(requestState: $requestState, message: $message, autovalidateMode: $autovalidateMode, type: $type)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, requestState, message, autovalidateMode, type);
...
abstract class _RegisterState implements RegisterState {
  const factory _RegisterState(
      ...
      final String message,
      final AutovalidateMode autovalidateMode,
      final UserType type}) = _$RegisterStateImpl;
