...
abstract class $CounterStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({int quantity, int availableQuantity});
}
...
class _$CounterStateImpl implements _CounterState {
  ...
  @override
  String toString() {
    return 'CounterState(quantity: $quantity, availableQuantity: $availableQuantity)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, quantity, availableQuantity);
...
abstract class _CounterState implements CounterState {
  const factory _CounterState(
      ...
      required final int availableQuantity}) = _$CounterStateImpl;
